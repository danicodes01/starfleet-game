...
export class Starfield {
  ...
  showingLevelSummary: boolean = false;
  summaryMessages: string[] = [];
  summaryMessageIndex: number = 0;
  ...
  moveCrosshair() {
    ...
    if (this.keysPressed["a"]) this.crosshair.x = Math.max(0, this.crosshair.x - cursorSpeed);
    if (this.keysPressed["d"]) this.crosshair.x = Math.min(this.canvas.width, this.crosshair.x + cursorSpeed);
    if (this.keysPressed["w"]) this.crosshair.y = Math.max(0, this.crosshair.y - cursorSpeed);
    if (this.keysPressed["s"]) this.crosshair.y = Math.min(this.canvas.height, this.crosshair.y + cursorSpeed);
  }
